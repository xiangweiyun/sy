package com.sy.center.auth.util;

import com.sy.center.auth.properties.JwtProperties;
import com.sy.center.common.utils.RandomUtil;
 ...
 * jwt token工具类
 * <p>
 * jwt的claim里一般包含以下几种数据: 1. iss -- token的发行者 2. sub -- 该JWT所面向的用户 3. aud --
 * 接收该JWT的一方 4. exp -- token的失效时间 5. nbf -- 在此时间段之前,不会被处理 6. iat -- jwt发布时间 7.
 * jti -- jwt唯一标识,防止重复使用
 *
 * @author xiangwy
 * @date: 2020-12-02 10:14:50
...
public class JwtTokenUtil {
    ...
    public String getRandomKey() {
        return RandomUtil.getRandomString(6);
    }
}